...
public class DownloadService {
    ...
    @HystrixCommand(
        ...
        commandKey = "downloadServiceCommandKey", // 따로 설정되지 않으면 메소드명으로 설정되고 동일한 메소드명이 있으면 오동작할 수 있으니 반드시 설정하자. 또한 application.yml에 설정을 추가할 때 사용한다.
        threadPoolKey = "downloadService", // threadPool별로 다르게 설정을 사용할 경우에 적용
